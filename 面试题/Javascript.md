...
19. 从实践角度来理解，函数中传入函数作为参数有什么意义，forEach 比 for 循环好在那里 ?
...
21. setTimeout 和 setInterval 的优缺点 ?

22. 如何判断 0.1 + 0.2 与 0.3 相等

23. 如何使用 JS 控制 div 元素在页面移动 ?
...
27. 使用 ES6 的 class 封装拖拽元素 ?

28. 如何实现元素的匀速运动、加速运动等各种运动方式 ?
...
40. 如何解决同步调用代码耗时太高的问题

41. symbol 应用

42. CommonJS 和 ES6 中模块引入的区别
