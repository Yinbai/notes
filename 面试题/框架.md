...
6. 有状态和无状态组件
   ...
   函数组件没有 this / state / 生命周期，似乎 hooks 可以支持函数组件使用 state 和生命周期
   ```
...
37. React key 场景题：列表使用 index 做 key，删除其中一个后，如何表现 ?
...
45. 如何在 redux 中定义 aciton

46. reducer 有什么作用

    `接收旧的 action 和 state，返回新的 state，纯函数`

47. store 在 redux 中的意义

48. redux 有哪些优点

49. react-redux 是如何工作的
...
54. 为什么 react-router v4 中使用 switch 关键字

55. react-router 的优点

56. react-router 与常规路由有什么区别